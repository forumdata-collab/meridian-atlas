...
const seeds: Seed[] = [
  ...
  [
    ...
    '辰',
    'SP',
    '承泣 四白 巨髎 地倉 大迎 頰車 下關 頭維 人迎 水突 氣舍 缺盆 氣戶 庫房 屋翳 膺窗 乳中 乳根 不容 承滿 梁門 關門 太乙 滑肉門 天樞 外陵 大巨 水道 歸來 氣衝 髀關 伏兔 陰市 梁丘 犢鼻 足三里 上巨虛 條口 下巨虛 豐隆 解溪 衝陽 陷谷 內庭 厲兑',
  ],
  [
    'SP',
    '足太陰脾經',
  ...
  [
    ...
    '',
    '',
    '長強 腰俞 腰陽關 命門 懸樞 脊中 中樞 筋縮 至陽 靈台 神道 身柱 陶道 大椎 啞門 風府 腦戶 強間 後頂 百會 前頂 囟會 上星 神庭 素髎 水溝 兑端 齦交',
  ],
];
