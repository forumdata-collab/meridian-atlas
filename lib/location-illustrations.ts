...
> = {
  LI17: {
    pdfPage: 51,
    printedPage: 42,
    note: '可對照天鼎與扶突、水突及胸鎖乳突肌的位置關係。',
  },
  LI18: {
    pdfPage: 51,
    printedPage: 42,
    note: '可對照扶突與胸鎖乳突肌前、後緣的位置關係。',
  },
  ST9: {
    pdfPage: 59,
    printedPage: 50,
    note: '圖中同時標出人迎、扶突、天窗，可對照三穴的同層及前後關係。',
  },
  ST10: {
    pdfPage: 59,
    printedPage: 50,
    note: '可對照水突、環狀軟骨及胸鎖乳突肌前緣的位置關係。',
  },
  SI16: {
    pdfPage: 104,
    printedPage: 95,
    note: '圖中同時標出天窗、扶突、人迎，可對照肌肉後緣位置。',
  },
};
...
export function getLocationIllustration(
  ...
  return {
    ...page,
    label: `WHO 定位圖示 · 2009 版 · PDF 第 ${page.pdfPage} 頁`,
